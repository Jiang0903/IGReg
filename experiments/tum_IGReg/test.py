...
class Tester(SingleTester):
    ...
    def after_test_step(self, iteration, data_dict, output_dict, result_dict):
        ...
        np.savez_compressed(
            ...
            # ref_anchor_corr_0_indices=release_cuda(output_dict['ref_anchor_corr_0_indices']),
            # src_anchor_corr_0_indices=release_cuda(output_dict['src_anchor_corr_0_indices']),
            # ref_anchor_corr_1_indices=release_cuda(output_dict['ref_anchor_corr_1_indices']),
            # src_anchor_corr_1_indices=release_cuda(output_dict['src_anchor_corr_1_indices']),

            # ref_scores_self1=release_cuda(output_dict['ref_scores_self1']),
            # ref_scores_self2=release_cuda(output_dict['ref_scores_self2']),
            # ref_scores_self3=release_cuda(output_dict['ref_scores_self3']),
            # src_scores_self1=release_cuda(output_dict['src_scores_self1']),
            # src_scores_self2=release_cuda(output_dict['src_scores_self2']),
            # src_scores_self3=release_cuda(output_dict['src_scores_self3']),

            # ref_scores_cross1=release_cuda(output_dict['ref_scores_cross1']),
            # ref_scores_cross2=release_cuda(output_dict['ref_scores_cross2']),
            # ref_scores_cross3=release_cuda(output_dict['ref_scores_cross3']),
            # src_scores_cross1=release_cuda(output_dict['src_scores_cross1']),
            # src_scores_cross2=release_cuda(output_dict['src_scores_cross2']),
            # src_scores_cross3=release_cuda(output_dict['src_scores_cross3']),
