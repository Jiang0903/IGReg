...
# data
_C.data = edict()
_C.data.dataset_root = osp.join(_C.root_dir, 'data', 'tum')
...
_C.eval.acceptance_radius = 0.1 # the threshold of Inlier Ratio(IR)
...
# optim
_C.optim = edict()
_C.optim.lr = 1e-4 # here we can change the learning rate
...
_C.coarse_matching.num_anchor = 3
_C.coarse_matching.r_nms = 0.05

# model - initialization
_C.initial_proj = edict()
_C.initial_proj.input_dim = 1024
_C.initial_proj.output_dim = 256

# model - GeoTransformer
_C.geotransformer = edict()
_C.geotransformer.input_dim = 1024
_C.geotransformer.image_dim = 256
_C.geotransformer.hidden_dim = 256
_C.geotransformer.output_dim = 256
_C.geotransformer.num_heads = 4
_C.geotransformer.blocks = ['cross','self']
_C.geotransformer.sigma_d = 0.2
_C.geotransformer.sigma_a = 15
_C.geotransformer.angle_k = 3
_C.geotransformer.reduction_a = 'sum'
